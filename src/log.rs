...
pub struct Log<'a> {
    ...
    pub target_processing_time: f64, // in seconds, with millisecond precision for target -> load balancer. Can be -1 if the connection closed
...
impl<'a> FromIterator<&'a str> for Log<'a> {
        ...
        I: IntoIterator<Item = &'a str>,
    {
        ...
        Self {
            ...
            target_processing_time: iter.next().unwrap().parse::<f64>().unwrap(),
